...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"对号"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"对号红"] forState:UIControlStateSelected];
