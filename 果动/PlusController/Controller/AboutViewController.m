...
-(void)onCreate
{
    ...
    aboutImageview.frame = CGRectMake((viewWidth - viewHeight/6.67)/2, viewHeight/6.67, viewHeight/6.67, viewHeight/6.67);
    ...
    label.frame = CGRectMake(0, CGRectGetMaxY(aboutImageview.frame) + viewHeight/33.35, viewWidth, viewHeight/13.34);
