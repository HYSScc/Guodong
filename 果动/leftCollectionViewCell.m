...
-(void)createUI
{
    self.classImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
    ...
    self.classNumberLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.classNameLabel.frame), self.frame.size.width, Adaptive(10))];
