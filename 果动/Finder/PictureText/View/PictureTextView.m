...
@interface PictureTextView ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)createUI {
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, viewWidth, LastHeight - Adaptive(10)) style:UITableViewStylePlain];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [finder pushWebViewWithName:picture.content_id];
