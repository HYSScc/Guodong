...
@interface QuestionView ()<UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate>
...
- (void)createUI {
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, viewWidth, self.bounds.size.height) style:UITableViewStyleGrouped];
...
- (void)publishButtonClick:(UIButton *)button {
    ...
    if ([HttpTool judgeWhetherUserLogin]) {
        ...
        [finder pushPublishViewWithName:@"答疑"];
    } else {
