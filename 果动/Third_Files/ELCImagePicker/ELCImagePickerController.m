...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect) {
        NSString *title = [NSString stringWithFormat:NSLocalizedString(@"提示", nil)];
        NSString *message = [NSString stringWithFormat:NSLocalizedString(@"一次只能发送%d张照片", nil), self.maximumImagesCount];
