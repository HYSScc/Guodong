...
- (void)addSpecifiedItem:(NSDictionary *)dic type:(NSString *)type
{
    ...
    if ([type isEqualToString:@"me"]) {
        NSString *URLStr = self.headimgstr;
    ...
    else
    {
        ...
        [dataDic setObject:@"coach" forKey:@"strName"];
    }
...
- (NSString *)getRandomString {
    ...
    NSString *lorumIpsum = @"If you are passionate about something,pursue it,no matter what anyone else thinks.That's how dreams are achieved.";
