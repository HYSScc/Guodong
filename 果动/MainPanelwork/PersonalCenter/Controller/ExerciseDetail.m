...
-(void)initView
{
    ...
    timelabel.font = [UIFont fontWithName:FONT size:viewHeight/55.583];
    [self.view addSubview:timelabel];
    
    oldtime = [[UILabel alloc] initWithFrame:CGRectMake(viewHeight/9.529 + (viewWidth - viewHeight/9.529)*0.25 - viewHeight/19.057, viewHeight/222.333, viewHeight/9.529, viewHeight/44.467)];
    oldtime.textColor = [UIColor lightGrayColor];
    oldtime.textAlignment = 1;
    oldtime.font = [UIFont fontWithName:FONT size:viewHeight/66.7];
    [self.view addSubview:oldtime];
    
    nowtime = [[UILabel alloc] initWithFrame:CGRectMake(viewHeight/9.529 + (viewWidth - viewHeight/9.529)*0.75 - viewHeight/19.057, viewHeight/222.333, viewHeight/9.529, viewHeight/44.467)];
    nowtime.textColor = [UIColor whiteColor];
    nowtime.textAlignment = 1;
    nowtime.font = [UIFont fontWithName:FONT size:viewHeight/66.7];
    
    orangeline = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(timelabel.frame), viewHeight/26.68, (viewWidth - viewHeight/9.529)*0.25, 1)];
  ...
  //  timeline.alpha = .8;
    ...
    scroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, viewHeight/16.675, viewWidth, viewHeight-64)];
    //是否允许弹性滑动
    ...
    photolabel.font = [UIFont fontWithName:FONT size:viewHeight/55.583];
    [scroll addSubview:photolabel];
    
    imgscroll = [[UIScrollView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(photolabel.frame),0, viewWidth - CGRectGetMaxX(photolabel.frame), 2592/(1936/((viewWidth - viewHeight/9.529)/2)))];
    imgscroll.contentSize = CGSizeMake(((viewWidth - viewHeight/9.529)/2)*2 + 2, 2592/(1936/((viewWidth - viewHeight/9.529)/2)));
    ...
    for (int a = 0; a < 4; a++) {
        UIImageView *imageview = [[UIImageView alloc] initWithFrame:CGRectMake(a*((viewWidth - viewHeight/9.529)/2+1), 0, ((viewWidth - viewHeight/9.529)/2), 2592/(1936/((viewWidth - viewHeight/9.529)/2)))];
        imageview.tag = 100+a;
    ...
    for (int a = 0; a < 26; a++) {
        UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(photoline.frame) + a*(viewHeight/16.675 + 0.5), viewHeight/9.529, viewHeight/16.675)];
        label.backgroundColor = [UIColor orangeColor];
        label.text = titleArray[a];
        label.textAlignment = 1;
        label.textColor = [UIColor whiteColor];
        label.font = [UIFont fontWithName:FONT size:viewHeight/60.636];
        ...
        UILabel *oldlabel = [[UILabel alloc] initWithFrame:CGRectMake(viewHeight/9.529, CGRectGetMaxY(photoline.frame) + a*(viewHeight/16.675 + 0.5), (viewWidth - CGRectGetMaxX(label.frame))/2, viewHeight/16.675)];
        oldlabel.font = [UIFont fontWithName:FONT size:viewHeight/47.643];
        oldlabel.textAlignment = 1;
        oldlabel.tag = a+2;
        oldlabel.textColor = [UIColor lightGrayColor];
        [scroll addSubview:oldlabel];
        
        UILabel *nowlabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(oldlabel.frame), CGRectGetMaxY(photoline.frame) + a*(viewHeight/16.675 +0.5), (viewWidth - CGRectGetMaxX(label.frame))/2, viewHeight/16.675)];
        nowlabel.tag = a+28;
        nowlabel.textColor = [UIColor whiteColor];
        nowlabel.textAlignment = 1;
        nowlabel.font = [UIFont fontWithName:FONT size:viewHeight/47.643];
