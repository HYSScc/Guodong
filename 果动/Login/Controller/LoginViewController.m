...
-(void)onCreate
{
    ...
    userimg.frame =CGRectMake((viewWidth - viewWidth/1.2)/2,viewHeight/1.6675, viewWidth/1.2, viewHeight/16.675);
    userimg.userInteractionEnabled = YES;
    [imageView addSubview:userimg];
    //152  141  112
    _textUserName=[[UITextField alloc]initWithFrame:CGRectMake((viewWidth - viewWidth/1.2)/2 + viewHeight/44.467,viewHeight/1.6675, viewWidth/1.2 - viewHeight/44.467, viewHeight/16.675)];
    ...
    _textPassword=[[UITextField alloc]initWithFrame:CGRectMake((viewWidth - viewWidth/1.2)/2 + viewHeight/66.7, CGRectGetMaxY(userimg.frame) + viewHeight/66.7, viewWidth/2.5 - viewHeight/66.7, viewHeight/16.675)];
