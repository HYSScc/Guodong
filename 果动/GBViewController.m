...
- (void)viewDidLoad {
    ...
    image2.frame = CGRectMake((viewWidth -viewHeight/7.096)/2, viewHeight/4.681, viewHeight/7.096, viewHeight/9.737);
    image2.image = [UIImage imageNamed:@"fabu_nobody"];
    
    noMoneyLabelTop = [[UILabel alloc] initWithFrame:CGRectMake(0, (CGRectGetMaxY(image2.frame) + viewHeight/33.35), viewWidth, viewHeight/33.35)];
    ...
    noMoneyLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(noMoneyLabelTop.frame) + viewHeight/66.7, viewWidth, viewHeight/44.467)];
    ...
    secondTFView = [[UIView alloc] initWithFrame:CGRectMake(0, viewHeight,  viewWidth, viewHeight/15.159)];
    ...
    secondTF = [[UITextField alloc]initWithFrame:CGRectMake(viewHeight/44.467,(secondTFView.bounds.size.height - viewHeight/22.233)/2,viewWidth - viewHeight/9.529,viewHeight/22.233)];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    headView.alpha = 0.8;
    headView.frame = CGRectMake(0, 0, viewWidth, viewHeight/11.117);
    headView.backgroundColor = [UIColor blackColor];
    
    headImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15,(headView.bounds.size.height-viewHeight/19.0575)/2,viewHeight/19.057,viewHeight/19.057)];
    ...
    CGSize userNameSize = [headLabel.text sizeWithAttributes:@{NSFontAttributeName:[UIFont fontWithName:FONT size:viewHeight/37.056]}];
    headLabel.frame = CGRectMake(CGRectGetMaxX(headImageView.frame)+viewHeight/133.4, (headView.bounds.size.height - userNameSize.height)/2, userNameSize.width, userNameSize.height);
    headLabel.textAlignment = 1;
    headLabel.font = [UIFont fontWithName:FONT size:viewHeight/41.6875];
    headLabel.textColor=[UIColor orangeColor];
    [headView addSubview:headLabel];
    
    UILabel *dateLabel = [[UILabel alloc] init];
    dateLabel.text = gdcomment.hour;
    dateLabel.frame = CGRectMake(viewWidth - viewHeight/6.064 - viewHeight/51.308, (headView.bounds.size.height - viewHeight/39.7024)/2, viewHeight/6.064, viewHeight/39.7024);
    dateLabel.textAlignment = 2;
    dateLabel.font = [UIFont fontWithName:FONT size:viewHeight/60.636];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0)
    {
        ...
        if ([gdc.type intValue] == 2) {
            ...
            CGSize cnumberSize = [picturecell.cnumberLabel.text sizeWithAttributes:@{NSFontAttributeName:[UIFont fontWithName:FONT size:viewHeight/37.056]}];
            picturecell.cnumberLabel.frame = CGRectMake(CGRectGetMaxX(picturecell.pImage.frame)+viewHeight/222.333,CGRectGetMinY(picturecell.pImage.frame),cnumberSize.width,cnumberSize.height);
            ...
            picturecell.likeButton.frame = CGRectMake(CGRectGetMaxX(picturecell.cnumberLabel.frame)+(viewHeight/66.7), CGRectGetMinY(picturecell.pImage.frame), viewHeight/27.2245,viewHeight/33.35);
            
            picturecell.znumberLabel.text = gdc.praises;
            CGSize znumberSize = [picturecell.znumberLabel.text sizeWithAttributes:@{NSFontAttributeName:[UIFont fontWithName:FONT size:viewHeight/37.056]}];
            picturecell.znumberLabel.frame = CGRectMake(CGRectGetMaxX(picturecell.likeButton.frame)+viewHeight/222.333,CGRectGetMinY(picturecell.likeButton.frame),znumberSize.width,znumberSize.height);
            
            
            if ([self.isMy intValue] == 999) {
                picturecell.removeButton.frame = CGRectMake(CGRectGetMaxX(picturecell.znumberLabel.frame) + viewHeight/44.467,CGRectGetMinY(picturecell.pImage.frame),viewHeight/40.4242,viewHeight/35.5733);
        ...
        else
        {
            ...
            moviecell.cnumberLabel.frame = CGRectMake(CGRectGetMaxX(moviecell.pImage.frame)+viewHeight/222.333,CGRectGetMinY(moviecell.pImage.frame),cnumberSize.width,cnumberSize.height);
            ...
            moviecell.znumberLabel.frame = CGRectMake(CGRectGetMaxX(moviecell.likeButton.frame)+viewHeight/222.333,CGRectGetMinY(moviecell.likeButton.frame),znumberSize.width,znumberSize.height);
            
            
            if ([self.isMy intValue] == 999) {
                moviecell.removeButton.frame = CGRectMake(CGRectGetMaxX(moviecell.znumberLabel.frame) + viewHeight/44.467,CGRectGetMinY(moviecell.pImage.frame),viewHeight/40.4242,viewHeight/35.5733);
    ...
    else if (indexPath.row == 1)
    {
        ...
        {
            if (gdc.praise_listArray.count < 6)
            {
...
>>>>>>> server/master
        ...
        if (!cell) {
            ...
            cell.selectionStyle = UITableViewCellSelectionStyleNone;
            //评论的头像
            cell.info_headimg = [[AsynImageView alloc] initWithFrame:CGRectMake(viewHeight/22.233, viewHeight/133.4, viewHeight/19.057, viewHeight/19.057)];
            ...
            cell.info_headlab.font = [UIFont fontWithName:FONT size:viewHeight/57.308];
            [cell addSubview:cell.info_headlab];
            
            //评论的时间
            cell.info_timelab = [[UILabel alloc] initWithFrame:CGRectMake(self.view.bounds.size.width-viewHeight/19.057 - viewHeight/9.529, CGRectGetMinY(cell.info_headimg.frame), viewHeight/9.529, viewHeight/47.643)];
            
            cell.info_timelab.textAlignment = 2;
            cell.info_timelab.textColor = [UIColor lightGrayColor];
            cell.info_timelab.font = [UIFont fontWithName:FONT size:viewHeight/66.7];
            ...
            cell.info_contentlab.font = [UIFont fontWithName:FONT size:viewHeight/51.308];
        ...
        CGSize info_headsize = [cell.info_headlab.text sizeWithAttributes:@{NSFontAttributeName:[UIFont fontWithName:FONT size:viewHeight/47.643]}];
        cell.info_headlab.frame = CGRectMake(CGRectGetMaxX(cell.info_headimg.frame)+viewHeight/133.4, CGRectGetMinY(cell.info_headimg.frame), info_headsize.width, info_headsize.height);
        ...
        CGSize info_content = [cell.info_contentlab.text boundingRectWithSize:CGSizeMake(viewWidth-viewHeight/13.34-viewHeight/19.057, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont fontWithName:FONT size:viewHeight/47.643]} context:nil].size;
        cell.info_contentlab.frame = CGRectMake(CGRectGetMaxX(cell.info_headimg.frame)+viewHeight/133.4, CGRectGetMaxY(cell.info_headlab.frame)+viewHeight/133.4, info_content.width, info_content.height);
        
        if (CGRectGetMaxY(cell.info_contentlab.frame) > CGRectGetMaxY(cell.info_headimg.frame)) {
            cell.info_line.frame = CGRectMake(CGRectGetMinX(cell.info_headimg.frame), CGRectGetMaxY(cell.info_contentlab.frame)+viewHeight/133.4, viewWidth - CGRectGetMinX(cell.info_headimg.frame)*2 , 1);
        }else{
            cell.info_line.frame = CGRectMake(CGRectGetMinX(cell.info_headimg.frame), CGRectGetMaxY(cell.info_headimg.frame)+viewHeight/133.4, viewWidth - CGRectGetMinX(cell.info_headimg.frame)*2, 0.5);
        }
        //回复评论
        //点击cell回复评论
...
-(void)keyboardShow:(NSNotification *)note
{
    ...
    if ( haveRelayCell == NO) {
        ...
        if ([keyName isEqual:@"First"]) {
            ...
            frame.origin.y = viewHeight - deltaY - viewHeight/15.159 - NavigationBar_Height;
            frame.origin.x = 0;
            secondTFView.frame = frame;
            
            if (frame.origin.y < cellOriginY) {
                _tableView.transform = CGAffineTransformMakeTranslation(0, frame.origin.y - cellOriginY - viewHeight/15.159 );
                NSLog(@"结果 %f",frame.origin.y - cellOriginY - viewHeight/15.159);
            }
        }
    }
}
...
-(void)replyComment:(UIGestureRecognizer *)gesture
{
    //通过点击评论、回复响应的输入框
    haveRelayCell = YES;
    if ([gesture.view isKindOfClass:[GBReplayCell class]]) { //回复cell
        liuyanType = @"2";
        GBReplayCell *cell = (GBReplayCell*)gesture.view;
        self.replay_id = cell.replay_id;
        self.info_id = cell.comment_id;
