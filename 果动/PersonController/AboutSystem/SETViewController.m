...
- (void)create
{
    for (int a = 0; a < 4; a++) {
        ...
        imageView.frame = CGRectMake(0, a * Adaptive(60), viewWidth, Adaptive(60));

        switch (a) {
        case 0: {

            imageView.image = [UIImage imageNamed:@"person_tiao"];
            UILabel* kefu = [[UILabel alloc] initWithFrame:CGRectMake(Adaptive(13),Adaptive(10), Adaptive(100), imageView.frame.size.height - Adaptive(20))];
            kefu.text = @"反馈";
            kefu.font = [UIFont fontWithName:FONT size:Adaptive(14)];
        ...
        case 1: {
            ...
            number = [[UILabel alloc] initWithFrame:CGRectMake(imageView.frame.size.width - Adaptive(112) - Adaptive(13), Adaptive(10), Adaptive(120), imageView.frame.size.height - Adaptive(20))];
            number.text = KEFU;
            number.textColor = [UIColor whiteColor];
            number.font = [UIFont fontWithName:FONT size:Adaptive(14)];
        ...
        case 2: {
            ...
            kbLabel = [[UILabel alloc] initWithFrame:CGRectMake(imageView.frame.size.width - Adaptive(130) - Adaptive(13), Adaptive(10), Adaptive(120), imageView.frame.size.height - Adaptive(20))];

            kbLabel.font = [UIFont fontWithName:FONT size:Adaptive(14)];
        ...
        case 3: {
            imageView.image = [UIImage imageNamed:@"person_tiao"];
            about = [[UILabel alloc] initWithFrame:CGRectMake(Adaptive(13), Adaptive(10), Adaptive(100), imageView.frame.size.height - Adaptive(20))];
            about.text = @"关于我们";
            about.font = [UIFont fontWithName:FONT size:Adaptive(14)];
    ...
    loginbutton.frame = CGRectMake(0, CGRectGetMaxY(imageView.frame) + Adaptive(14), viewWidth, Adaptive(60));

    [self.view addSubview:loginbutton];

    cleanLabel = [[UILabel alloc] initWithFrame:CGRectMake(viewWidth / 3, CGRectGetMaxY(loginbutton.frame) +Adaptive(100), viewWidth / 3, Adaptive(40))];
    cleanLabel.backgroundColor = [UIColor colorWithRed:55 / 255.0 green:55 / 255.0 blue:55 / 255.0 alpha:1];
    cleanLabel.text = @"清理成功";
    cleanLabel.layer.cornerRadius = 3;
    cleanLabel.layer.masksToBounds = YES;
    cleanLabel.textAlignment = 1;
    cleanLabel.textColor = [UIColor lightGrayColor];
    cleanLabel.font = [UIFont fontWithName:FONT size:Adaptive(14)];
}
#pragma mark 登陆注册按钮
